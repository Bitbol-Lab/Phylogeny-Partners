...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/home/andonis/ARPE/git_repo/Phylogeny-Partners-Lab-light/2_states_generation_inference/cython_code/analyse_sequence.pyx"
        ]
    },
...
static int __pyx_f_11cython_code_16analyse_sequence_freq_to_pos(double, int, double, double); /*proto*/
...
static const char __pyx_k_freqs1[] = "freqs1";
static const char __pyx_k_freqs2[] = "freqs2";
...
static const char __pyx_k_image_plot_freq[] = "image_plot_freq";
...
static const char __pyx_k_image_plot_freq_simple[] = "image_plot_freq_simple";
...
static PyObject *__pyx_n_s_freqs1;
static PyObject *__pyx_n_s_freqs2;
static PyObject *__pyx_n_s_getstate;
static PyObject *__pyx_kp_s_got_differing_extents_in_dimensi;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_id;
static PyObject *__pyx_n_s_ima;
static PyObject *__pyx_n_s_image_plot_freq;
static PyObject *__pyx_n_s_image_plot_freq_simple;
...
static PyObject *__pyx_pf_11cython_code_16analyse_sequence_10image_plot_freq(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_freqs1, __Pyx_memviewslice __pyx_v_freqs2, int __pyx_v_val, double __pyx_v_xmin, double __pyx_v_xmax); /* proto */
static PyObject *__pyx_pf_11cython_code_16analyse_sequence_12image_plot_freq_simple(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_freqs1, __Pyx_memviewslice __pyx_v_freqs2, int __pyx_v_val, double __pyx_v_xmin, double __pyx_v_xmax); /* proto */
 ...
 */
          ...
          if ((1 == 0)) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_15, __pyx_t_6) firstprivate(__pyx_t_13, __pyx_t_14)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
...
/* "cython_code/analyse_sequence.pyx":140
 * 
 * 
...
static PyObject *__pyx_pf_11cython_code_16analyse_sequence_10image_plot_freq(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_freqs1, __Pyx_memviewslice __pyx_v_freqs2, int __pyx_v_val, double __pyx_v_xmin, double __pyx_v_xmax) {
  ...
  /* "cython_code/analyse_sequence.pyx":142
 * def image_plot_freq(double[:,:,:,:] freqs1, double[:,:,:,:] freqs2, int val=1000, double xmin=0, double xmax=1):
 *     cdef:
 *         int[:,::1] ima = np.zeros((val,val), dtype=np.intc)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_code/analyse_sequence.pyx":148
                    ...
                    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                        {
                            ...
                            /* "cython_code/analyse_sequence.pyx":149
 * 
 *     for i in prange(freqs1.shape[0] - 2, nogil=True):
 *         for j in range(freqs1.shape[1]):             # <<<<<<<<<<<<<<
 *             for k in range(i+1, freqs1.shape[2]):
 ...
 */
                            ...
                            for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
                              ...
                              /* "cython_code/analyse_sequence.pyx":150
 *     for i in prange(freqs1.shape[0] - 2, nogil=True):
 *         for j in range(freqs1.shape[1]):
 *             for k in range(i+1, freqs1.shape[2]):             # <<<<<<<<<<<<<<
 *                 for l in range(freqs1.shape[3]):
 ...
 */
                              ...
                              for (__pyx_t_15 = (__pyx_v_i + 1); __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
                                ...
                                /* "cython_code/analyse_sequence.pyx":151
 *         for j in range(freqs1.shape[1]):
 *             for k in range(i+1, freqs1.shape[2]):
 *                 for l in range(freqs1.shape[3]):             # <<<<<<<<<<<<<<
 *                     pos1 = freq_to_pos(freqs1[i,j,k,l], val, xmin, xmax)
 ...
 */
                                ...
                                for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=1) {
                                  ...
                                  /* "cython_code/analyse_sequence.pyx":152
 *             for k in range(i+1, freqs1.shape[2]):
 *                 for l in range(freqs1.shape[3]):
 *                     pos1 = freq_to_pos(freqs1[i,j,k,l], val, xmin, xmax)             # <<<<<<<<<<<<<<
 *                     pos2 = freq_to_pos(freqs2[i,j,k,l], val, xmin, xmax)
 ...
 */
                                  ...
                                  /* "cython_code/analyse_sequence.pyx":153
 *                 for l in range(freqs1.shape[3]):
 *                     pos1 = freq_to_pos(freqs1[i,j,k,l], val, xmin, xmax)
 *                     pos2 = freq_to_pos(freqs2[i,j,k,l], val, xmin, xmax)             # <<<<<<<<<<<<<<
 *                     ima[pos1, pos2] += 1
 ...
 */
                                  ...
                                  /* "cython_code/analyse_sequence.pyx":154
 *                     pos1 = freq_to_pos(freqs1[i,j,k,l], val, xmin, xmax)
 *                     pos2 = freq_to_pos(freqs2[i,j,k,l], val, xmin, xmax)
 *                     ima[pos1, pos2] += 1             # <<<<<<<<<<<<<<
 *     return np.asarray(ima)
 ...
 */
  ...
  /* "cython_code/analyse_sequence.pyx":155
 *                     pos2 = freq_to_pos(freqs2[i,j,k,l], val, xmin, xmax)
 *                     ima[pos1, pos2] += 1
 *     return np.asarray(ima)             # <<<<<<<<<<<<<<
 * 
...
/* "cython_code/analyse_sequence.pyx":157
 *     return np.asarray(ima)
 * 
 * def image_plot_freq_simple(double[::1] freqs1, double[::1] freqs2, int val=1000, double xmin=0, double xmax=1):             # <<<<<<<<<<<<<<
 *     cdef:
...
static PyObject *__pyx_pf_11cython_code_16analyse_sequence_12image_plot_freq_simple(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_freqs1, __Pyx_memviewslice __pyx_v_freqs2, int __pyx_v_val, double __pyx_v_xmin, double __pyx_v_xmax) {
  ...
  /* "cython_code/analyse_sequence.pyx":159
 * def image_plot_freq_simple(double[::1] freqs1, double[::1] freqs2, int val=1000, double xmin=0, double xmax=1):
 *     cdef:
 *         int[:,::1] ima = np.zeros((val,val), dtype=np.intc)             # <<<<<<<<<<<<<<
 *         int i,pos1,pos2
 ...
 */
  ...
  /* "cython_code/analyse_sequence.pyx":162
 *         int i,pos1,pos2
 * 
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_10, __pyx_t_11)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    ...
                    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                        {
                            ...
                            /* "cython_code/analyse_sequence.pyx":163
 * 
 *     for i in prange(freqs1.shape[0], nogil=True):
 *                     pos1 = freq_to_pos(freqs1[i], val, xmin, xmax)             # <<<<<<<<<<<<<<
 *                     pos2 = freq_to_pos(freqs2[i], val, xmin, xmax)
 ...
 */
                            ...
                            /* "cython_code/analyse_sequence.pyx":164
 *     for i in prange(freqs1.shape[0], nogil=True):
 *                     pos1 = freq_to_pos(freqs1[i], val, xmin, xmax)
 *                     pos2 = freq_to_pos(freqs2[i], val, xmin, xmax)             # <<<<<<<<<<<<<<
 *                     ima[pos1, pos2] += 1
 ...
 */
                            ...
                            /* "cython_code/analyse_sequence.pyx":165
 *                     pos1 = freq_to_pos(freqs1[i], val, xmin, xmax)
 *                     pos2 = freq_to_pos(freqs2[i], val, xmin, xmax)
 *                     ima[pos1, pos2] += 1             # <<<<<<<<<<<<<<
 *     return np.asarray(ima)
 ...
 */
  ...
  /* "cython_code/analyse_sequence.pyx":166
 *                     pos2 = freq_to_pos(freqs2[i], val, xmin, xmax)
 *                     ima[pos1, pos2] += 1
 *     return np.asarray(ima)             # <<<<<<<<<<<<<<
 * 
...
/* "cython_code/analyse_sequence.pyx":169
 * 
 * 
...
static int __pyx_f_11cython_code_16analyse_sequence_freq_to_pos(double __pyx_v_freq, int __pyx_v_val, double __pyx_v_xmin, double __pyx_v_xmax) {
  ...
  /* "cython_code/analyse_sequence.pyx":170
 * 
 * cdef int freq_to_pos(double freq, int val, double xmin, double xmax) nogil:
 *     return int((freq-xmin)*(val-1)/(xmax-xmin))             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_freqs1, __pyx_k_freqs1, sizeof(__pyx_k_freqs1), 0, 0, 1, 1},
  {&__pyx_n_s_freqs2, __pyx_k_freqs2, sizeof(__pyx_k_freqs2), 0, 0, 1, 1},
  {&__pyx_n_s_getstate, __pyx_k_getstate, sizeof(__pyx_k_getstate), 0, 0, 1, 1},
  {&__pyx_kp_s_got_differing_extents_in_dimensi, __pyx_k_got_differing_extents_in_dimensi, sizeof(__pyx_k_got_differing_extents_in_dimensi), 0, 0, 1, 0},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_id, __pyx_k_id, sizeof(__pyx_k_id), 0, 0, 1, 1},
  {&__pyx_n_s_ima, __pyx_k_ima, sizeof(__pyx_k_ima), 0, 0, 1, 1},
  {&__pyx_n_s_image_plot_freq, __pyx_k_image_plot_freq, sizeof(__pyx_k_image_plot_freq), 0, 0, 1, 1},
  {&__pyx_n_s_image_plot_freq_simple, __pyx_k_image_plot_freq_simple, sizeof(__pyx_k_image_plot_freq_simple), 0, 0, 1, 1},
