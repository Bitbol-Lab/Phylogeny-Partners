...
L = 176
Field, Coupling = im.import_msa_bmDCA(path_file, L)
...
np.save("data_bmdca/msa_no_phylo_bmdca_%s"%name_fasta, msa_no_phylo)
np.save("data_bmdca/msa_phylo_bmdca_tree_%s"%name_fasta, msa_phylo_tree)
np.save("data_bmdca/msa_phylo_equi_bmdca_tree_%s"%name_fasta, msa_phylo_equi_tree)
